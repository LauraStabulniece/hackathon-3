...
function Courchevel() {
    return (
        <div>
            <p class="subsequence">
                <Link className='nav-link' to="/">Home &gt; <Link className='nav-link' to="/winterdestination">Winter Destination &gt; <Link className='nav-link' to="/courchevel">Courchevel</Link></Link></Link>
            </p>
            <DestinationPage
                title='Courchevel'
