...
function BaliTravel() {
    return (
        <div>
            <p class="subsequence">
                <Link className='nav-link' to="/">Home &gt; <Link className='nav-link' to="/summerdestination">Summer Destination &gt; <Link className='nav-link' to="/bali">Bali</Link></Link></Link>
            </p>
            <DestinationPage
                title='Bali'
                ...
                categoryName='Summer destination'
                categoryLink='/bali'
                travelPrice='2,000 EUR'
            >
            </DestinationPage>
        </div>
    )
}
export default BaliTravel;
