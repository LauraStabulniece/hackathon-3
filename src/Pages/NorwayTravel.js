...
function NorwayTravel() {
    return (
        <div>
            <p class="subsequence">
                <Link className='nav-link' to="/">Home &gt; <Link className='nav-link' to="/hiking">Hiking &gt; <Link className='nav-link' to="/norway">Norway</Link></Link></Link>
            </p>
            <DestinationPage
                title='Norway'
                ...
                categoryName='Hiking'
                categoryLink='/hiking'
                travelPrice='2,300 EUR'
            >
            </DestinationPage>
        </div>
    )
}
export default NorwayTravel;
